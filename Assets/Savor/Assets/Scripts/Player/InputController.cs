...
namespace Undercooked.Player
{
    public class InputController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            Assert.IsNotNull(playerControllers);
            #endif
        }
        ...
        internal void EnableFirstPlayerController()
        {
            ...
            {
                foreach (var pc in playerControllers) pc.DeactivatePlayer();
                _isFirstPlayerControllerActive = false;
                return;
            }
            playerControllers[1].DeactivatePlayer();
            playerControllers[0].ActivatePlayer();
        ...
        internal void EnableSecondPlayerController()
        {
            ...
            playerControllers[0].DeactivatePlayer();
            playerControllers[1].ActivatePlayer();
            _isFirstPlayerControllerActive = false;
